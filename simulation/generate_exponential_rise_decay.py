...
for age in age_list:
    ...
    np.save(
        os.path.join(
            ...
            f"spectrum_{age:.1f}_gyr_{tau:.1f}_rise_decay",
        ),
        data_out,
    )
    plt.figure(1)
    ...
    plt.savefig(
        os.path.join(
            "output",
            "exponential_rise_decay",
            f"spectrum_{age:.1f}_gyr_{tau:.1f}_rise_decay.png",
        )
    )
    np.save(
        os.path.join(
            ...
            f"spectrum_{age:.1f}_gyr_{tau:.1f}_rise_decay_with_noise_10",
        ),
    ...
    np.save(
        os.path.join(
            "output",
            "exponential_rise_decay_with_noise",
            f"spectrum_{age:.1f}_gyr_{tau:.1f}_rise_decay_with_noise_20",
        ),
    ...
    np.save(
        os.path.join(
            "output",
            "exponential_rise_decay_with_noise",
            f"spectrum_{age:.1f}_gyr_{tau:.1f}_rise_decay_with_noise_50",
        ),
