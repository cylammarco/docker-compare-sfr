...
#     configuration file:
config_file = data_path + 'auto_ssp.config'
...
plt.ylabel('flux')
plt.plot(wave__w[sel__w], flux_org__w[sel__w], wave__w[sel__w],
         model__w[sel__w], wave__w[sel__w], res__w[sel__w])
...
plt.savefig('fig_2_inspect_gas_spectrum.jpg')
...
plt.ylabel('flux')
plt.plot(wave__w[sel__w], gas__w[sel__w])
plt.savefig('fig_3_inspect_NII_Ha.jpg')
...
# output spectra
filename = data_path + f'NII_Ha.{name}.txt'
...
config_filename = 'out_config.fit_spectra'
